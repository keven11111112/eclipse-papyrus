 ...
 *     Mickael ADAM (ALL4TEC) mickael.adam@all4tec.net - integrate it to take into account of gridData width
 *******************************************************************************/
 ...
 * 
 */
public final class PapyrusRowLayout extends Layout {
	 ...
	 * Possible values are:
	 * <ul>
	 * <li>HORIZONTAL: Position the controls horizontally from left to right
	 * </li>
	 ...
	 * @since 2.0
	 */
	public PapyrusRowLayout(int type) {
		this.type = type;
	}
	...
	protected Point computeSize(Composite composite, int wHint, int hHint, boolean flushCache) {
		...
		if (type == SWT.HORIZONTAL) {
			if (composite.getLayoutData() instanceof GridData) {
				wHint = ((GridData) composite.getLayoutData()).currentWhint;
			}
