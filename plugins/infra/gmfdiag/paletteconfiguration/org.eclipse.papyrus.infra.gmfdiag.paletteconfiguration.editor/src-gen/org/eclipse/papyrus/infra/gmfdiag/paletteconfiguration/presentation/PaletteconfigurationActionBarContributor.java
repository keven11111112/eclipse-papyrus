...
public class PaletteconfigurationActionBarContributor
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(PaletteConfigurationEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(PaletteConfigurationEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PaletteConfigurationEditorPlugin.INSTANCE.getString("_UI_PaletteconfigurationEditor_menu"), "org.eclipse.papyrus.infra.gmfdiag.paletteconfigurationMenuID");
