...
public class PartialCSSContentAssistParser extends CSSParser implements IPartialContentAssistParser {
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		...
		PolymorphicDispatcher<Collection<FollowElement>> dispatcher = new PolymorphicDispatcher<Collection<FollowElement>>(methodName, 0, 0, Collections.singletonList(parser));
		dispatcher.invoke();
