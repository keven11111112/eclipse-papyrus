...
public class CSSFormatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(FormattingConfig c) {
		CSSGrammarAccess f = (CSSGrammarAccess)getGrammarAccess();
	...
	public static class SemanticWSEaterFormattingConfigBasedStream extends FormattingConfigBasedStream {
		...
		public SemanticWSEaterFormattingConfigBasedStream(ITokenStream out, String initialIndentation, FormattingConfig cfg, IElementMatcher<ElementPattern> matcher, IHiddenTokenHelper hiddenTokenHelper, boolean preserveSpaces) {
