...
public class CSSFactoryImpl extends EFactoryImpl implements CSSFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case CSSPackage.CHARSET: return createcharset();
      case CSSPackage.IMPORT_EXPRESSION: return createimportExpression();
      case CSSPackage.PAGE: return createpage();
      case CSSPackage.MEDIA: return createmedia();
      case CSSPackage.FONT_FACE: return createfont_face();
      case CSSPackage.KEYFRAMES: return createkeyframes();
      case CSSPackage.KEYFRAME_SELECTOR: return createkeyframe_selector();
      case CSSPackage.RULESET: return createruleset();
      case CSSPackage.SELECTOR: return createselector();
      case CSSPackage.SIMPLE_SELECTOR_FOR_NEGATION: return createSimpleSelectorForNegation();
      case CSSPackage.CSS_SELECTOR: return createCssSelector();
      case CSSPackage.SIMPLE_SELECTOR: return createsimple_selector();
      case CSSPackage.CLASS_SELECTOR: return createClassSelector();
      case CSSPackage.ELEMENT_SELECTOR: return createElementSelector();
      case CSSPackage.UNIVERSAL_SELECTOR: return createUniversalSelector();
      case CSSPackage.ID_SELECTOR: return createIdSelector();
      case CSSPackage.CSS_DECLARATION: return createcss_declaration();
      case CSSPackage.CSS_PROPERTY: return createcss_property();
      case CSSPackage.PSEUDO_CLASS_OR_FUNC: return createPseudoClassOrFunc();
      case CSSPackage.PSEUDO_CLASS: return createPseudoClass();
      case CSSPackage.PSEUDO_CLASS_NAME: return createPseudoClassName();
      case CSSPackage.PSEUDO_CLASS_FUNCTION: return createPseudoClassFunction();
      case CSSPackage.CSS_TOK: return createCssTok();
      case CSSPackage.URL_TYPE: return createURLType();
      case CSSPackage.ATTRIBUTE_SELECTOR: return createAttributeSelector();
      case CSSPackage.SYMBOL_TOK: return createSymbolTok();
      case CSSPackage.WS_TOK: return createWSTok();
      case CSSPackage.STRING_TOK: return createStringTok();
      case CSSPackage.NUMBER_TOK: return createNumberTok();
      case CSSPackage.URL_TOK: return createUrlTok();
      case CSSPackage.COLOR_TOK: return createColorTok();
      case CSSPackage.IDENTIFIER_TOK: return createIdentifierTok();
      case CSSPackage.FUNC_TOK: return createFuncTok();
      default:
