...
/**
 * Duplicated and adapted from org.eclipse.gmf.runtime.gef.ui.internal.editpolicies.ConnectionBendpointEditPolicy
 */
/**
 * This EditPolicy defines the behavior of Bendpoints on a Connection.
 */
abstract public class GMF_GEF_ConnectionBendpointEditPolicy extends SelectionHandlesEditPolicy implements PropertyChangeListener {
	...
	static protected class FeedbackState {
	...
	//changed to protected
	protected FeedbackState getFeedbackState() {
	 ...
	 * @param lineSegMode
	 */
	public GMF_GEF_ConnectionBendpointEditPolicy(LineMode lineSegMode) {
		super();
	 ...
	 * bendpoints will have {@link BendpointMoveHandle}s on them with a single {@link BendpointCreationHandle} between 2 consecutive explicit
	 * bendpoints.
	 ...
	 * 
	 * @param p1
	 *        Point that is the first point in the line segment to test against.
	 * @param p2
	 *        Point that is the second point in the line segment to test against.
	 * @param p
	 *        Point that is tested to see if it falls in the line segment defined by p1 and p2.
	 ...
	 * 
	 * @param request
	 *        BendpointRequest from the user gesture for moving / creating a bendpoint
	 ...
	 *        the index
	 * @param constraint
	 *        List of Bendpoint objects that is the constraint to the gesture.
	 * @param moveLine
