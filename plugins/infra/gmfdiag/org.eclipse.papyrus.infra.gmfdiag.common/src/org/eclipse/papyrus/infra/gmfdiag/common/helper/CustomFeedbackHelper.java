...
public class CustomFeedbackHelper extends FeedbackHelper {
	...
	//	//		}
	//	//
	//	//		final Point newPoint = anchor.getReferencePoint();
	//	//		final List<RelativeBendpoint> currentConstraint = getCurrentConnectionConstraint();
	//	//
	//	//		//		final 
	//	//
	//	//		System.out.println("OLD point" + oldPoint);
	//	//		System.out.println("NEW anchor" + anchor.getReferencePoint());
	//	//
	//	//
	...
	//	//
	//	//		//une nouvelle ligne a tester
	//	//		dummyConnection.setParent(getConnection().getParent());
	//	//
	//	//		if(isMovingStartAnchor()) {
