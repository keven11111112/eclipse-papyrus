...
public class ExpansionmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpansionmodelPackage.GMFT_BASED_REPRESENTATION: {
				GMFT_Based_Representation gmfT_Based_Representation = (GMFT_Based_Representation)theEObject;
				T result = caseGMFT_Based_Representation(gmfT_Based_Representation);
				if (result == null) result = caseRepresentation(gmfT_Based_Representation);
				if (result == null) result = caseAbstractRepresentation(gmfT_Based_Representation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseGMFT_Based_Representation(GMFT_Based_Representation object) {
		return null;
	}
