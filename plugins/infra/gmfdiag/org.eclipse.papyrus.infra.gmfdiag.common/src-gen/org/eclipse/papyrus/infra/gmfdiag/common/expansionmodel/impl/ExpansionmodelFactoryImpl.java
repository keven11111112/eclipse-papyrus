...
public class ExpansionmodelFactoryImpl extends EFactoryImpl implements ExpansionmodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExpansionmodelPackage.LIBRARY: return createLibrary();
			case ExpansionmodelPackage.USE_CONTEXT: return createUseContext();
			case ExpansionmodelPackage.GMFT_BASED_REPRESENTATION: return createGMFT_Based_Representation();
	...
	public GMFT_Based_Representation createGMFT_Based_Representation() {
		GMFT_Based_RepresentationImpl gmfT_Based_Representation = new GMFT_Based_RepresentationImpl();
