...
public class ExpansionmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExpansionmodelSwitch<Adapter> modelSwitch =
		new ExpansionmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGMFT_Based_Representation(GMFT_Based_Representation object) {
				return createGMFT_Based_RepresentationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.gmfdiag.common.expansionmodel.GMFT_Based_Representation <em>GMFT Based Representation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
