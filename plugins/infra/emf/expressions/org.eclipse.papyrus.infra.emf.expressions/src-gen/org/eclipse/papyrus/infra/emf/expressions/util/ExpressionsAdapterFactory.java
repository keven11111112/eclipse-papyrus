...
public class ExpressionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExpressionsSwitch<Adapter> modelSwitch =
		new ExpressionsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExpressionCatalog(ExpressionCatalog object) {
				return createExpressionCatalogAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.emf.expressions.ExpressionCatalog <em>Expression Catalog</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpressionCatalogAdapter() {
		return null;
	}
