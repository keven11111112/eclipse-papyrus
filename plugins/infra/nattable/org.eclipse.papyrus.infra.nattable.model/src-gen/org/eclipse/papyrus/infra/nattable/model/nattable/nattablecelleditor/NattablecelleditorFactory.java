...
public interface NattablecelleditorFactory extends EFactory {
	 ...
	 * @generated
	 */
	NattablecelleditorFactory eINSTANCE = org.eclipse.papyrus.infra.nattable.model.nattable.nattablecelleditor.impl.NattablecelleditorFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Generic Relationship Matrix Cell Editor Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Generic Relationship Matrix Cell Editor Configuration</em>'.
	 * @generated
	 */
