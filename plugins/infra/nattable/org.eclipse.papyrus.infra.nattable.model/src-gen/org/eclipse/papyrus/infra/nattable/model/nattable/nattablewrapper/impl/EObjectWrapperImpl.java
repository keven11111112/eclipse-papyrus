 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.infra.nattable.model.nattable.nattablewrapper.impl.EObjectWrapperImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EObjectWrapperImpl extends StyledElementImpl implements EObjectWrapper {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NattablewrapperPackage.EOBJECT_WRAPPER__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(EObject newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NattablewrapperPackage.EOBJECT_WRAPPER__ELEMENT, oldElement, element));
	}
