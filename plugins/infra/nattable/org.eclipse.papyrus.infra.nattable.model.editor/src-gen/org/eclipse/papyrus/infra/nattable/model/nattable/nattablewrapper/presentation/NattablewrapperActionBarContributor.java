...
/**
 * This is the action bar contributor for the Nattablewrapper model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NattablewrapperActionBarContributor
	 ...
	 * @generated
	 */
	public NattablewrapperActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("nattablewrapper-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("nattablewrapper-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(NattableEditorPlugin.INSTANCE.getString("_UI_NattablewrapperEditor_menu"), "org.eclipse.papyrus.infra.nattable.model.nattable.nattablewrapperMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
