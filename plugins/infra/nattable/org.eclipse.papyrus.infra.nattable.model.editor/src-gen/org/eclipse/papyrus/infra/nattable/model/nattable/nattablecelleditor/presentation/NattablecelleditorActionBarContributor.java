...
/**
 * This is the action bar contributor for the Nattablecelleditor model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NattablecelleditorActionBarContributor
	 ...
	 * @generated
	 */
	public NattablecelleditorActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("nattablecelleditor-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("nattablecelleditor-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(NattableEditorPlugin.INSTANCE.getString("_UI_NattablecelleditorEditor_menu"), "org.eclipse.papyrus.infra.nattable.model.nattable.nattablecelleditorMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
