...
public class ComponentRealizationAppliedStereotypeEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.composite.edit.parts.ComponentRealizationAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 30));
	}
	...
	*/
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														ComponentRealizationAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ComponentRealization_Edge, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
