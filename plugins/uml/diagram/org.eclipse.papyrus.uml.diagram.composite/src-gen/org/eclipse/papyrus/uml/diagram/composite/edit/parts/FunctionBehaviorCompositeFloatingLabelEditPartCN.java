...
public class FunctionBehaviorCompositeFloatingLabelEditPartCN extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.composite.edit.parts.FunctionBehaviorCompositeFloatingLabelEditPartCN.VISUAL_ID),
				new Point(0, 0));
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														FunctionBehaviorCompositeFloatingLabelEditPartCN.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.FunctionBehavior_Shape_CN, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
