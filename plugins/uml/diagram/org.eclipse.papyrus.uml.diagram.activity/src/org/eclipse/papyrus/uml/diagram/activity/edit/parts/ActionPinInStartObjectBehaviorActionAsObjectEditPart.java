...
public class ActionPinInStartObjectBehaviorActionAsObjectEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActionPinInStartObjectBehaviorActionAsObjectLabelEditPart) {
			...
			if (borderItemEditPart instanceof ActionPinInStartObjectBehaviorActionAsObjectValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ActionPinInStartObjectBehaviorActionAsObjectAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
