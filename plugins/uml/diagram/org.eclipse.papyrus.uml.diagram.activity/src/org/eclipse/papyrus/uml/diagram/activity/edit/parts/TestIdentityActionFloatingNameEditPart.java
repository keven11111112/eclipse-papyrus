...
public class TestIdentityActionFloatingNameEditPart extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.activity.edit.parts.TestIdentityActionFloatingNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																TestIdentityActionFloatingNameEditPart.this),
														(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.TestIdentityAction_Shape, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
