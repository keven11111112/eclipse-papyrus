...
public class InputPinInReadStructuralFeatureAsObjectAppliedStereotypeWrappingLabelEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInReadStructuralFeatureAsObjectAppliedStereotypeWrappingLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														InputPinInReadStructuralFeatureAsObjectAppliedStereotypeWrappingLabelEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_ReadStructuralFeatureActionObjectShape,
