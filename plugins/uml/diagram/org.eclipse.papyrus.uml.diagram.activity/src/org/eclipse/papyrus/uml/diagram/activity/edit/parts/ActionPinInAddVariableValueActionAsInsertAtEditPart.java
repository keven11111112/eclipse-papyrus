...
public class ActionPinInAddVariableValueActionAsInsertAtEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActionPinInAddVariableValueActionAsInsertAtLabelEditPart) {
			...
			if (borderItemEditPart instanceof ActionPinInAddVariableValueActionAsInsertAtValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ActionPinInAddVariableValueActionAsInsertAtAppliedStereotypeWrappingLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
