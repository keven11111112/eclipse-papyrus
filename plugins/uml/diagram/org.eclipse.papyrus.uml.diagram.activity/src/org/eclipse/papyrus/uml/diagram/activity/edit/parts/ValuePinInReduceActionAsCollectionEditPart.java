...
public class ValuePinInReduceActionAsCollectionEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ValuePinInReduceActionAsCollectionLabelEditPart) {
			...
			if (borderItemEditPart instanceof ValuePinInReduceActionAsCollectionValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ValuePinInReduceActionAsCollectionAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
