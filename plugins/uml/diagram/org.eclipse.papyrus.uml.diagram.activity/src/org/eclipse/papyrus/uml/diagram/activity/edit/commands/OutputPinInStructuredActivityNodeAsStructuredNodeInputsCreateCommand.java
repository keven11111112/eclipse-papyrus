 ...
 * @generated
 */
public class OutputPinInStructuredActivityNodeAsStructuredNodeInputsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPinInStructuredActivityNodeAsStructuredNodeInputsCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				qualifiedTarget.getStructuredNodeOutputs().add(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_OutputPin_3191(newElement);
