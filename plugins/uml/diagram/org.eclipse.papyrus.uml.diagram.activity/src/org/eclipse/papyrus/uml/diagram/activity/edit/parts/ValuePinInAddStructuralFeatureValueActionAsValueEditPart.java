...
public class ValuePinInAddStructuralFeatureValueActionAsValueEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ValuePinInAddStructuralFeatureValueActionAsValueLabelEditPart) {
			...
			if (borderItemEditPart instanceof ValuePinInAddStructuralFeatureValueActionAsValueValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ValuePinInAddStructuralFeatureValueActionAsValueAppliedStereotypeWrappingLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
