 ...
 * @generated
 */
public class ActionPinInAddStructuralFeatureValueActionAsInserAtCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInAddStructuralFeatureValueActionAsInserAtCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				AddStructuralFeatureValueAction qualifiedTarget = (AddStructuralFeatureValueAction) target;
				qualifiedTarget.setInsertAt(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3187(newElement);
