...
public class ActionPinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "5383";
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActionInputPin_3190, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionPinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart.VISUAL_ID));
		}
		return parser;
	}
