...
public class ActionInputPinInCallOpActAsTargetEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActionInputPinInCOActAsTargetLabelEditPart) {
			...
			if (borderItemEditPart instanceof ActionInputPinInCOActAsTargetValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ActionInputPinInCOActAsTargetAppliedStereotypeEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
