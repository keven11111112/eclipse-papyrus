...
public class CallOperationActionFloatingNameEditPart extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.activity.edit.parts.CallOperationActionFloatingNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																CallOperationActionFloatingNameEditPart.this),
														(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.CallOperationAction_Shape, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
