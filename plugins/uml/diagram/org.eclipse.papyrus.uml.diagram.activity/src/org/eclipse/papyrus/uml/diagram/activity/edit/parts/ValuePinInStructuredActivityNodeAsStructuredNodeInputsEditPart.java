...
public class ValuePinInStructuredActivityNodeAsStructuredNodeInputsEditPart extends AbstractPinEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart) {
			...
			if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else
				if (borderItemEditPart instanceof ValuePinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
