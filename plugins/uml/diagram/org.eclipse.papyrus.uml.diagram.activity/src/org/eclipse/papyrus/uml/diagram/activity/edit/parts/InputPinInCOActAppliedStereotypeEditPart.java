...
public class InputPinInCOActAppliedStereotypeEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInCOActAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														InputPinInCOActAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_CallOperationActionArgumentShape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
