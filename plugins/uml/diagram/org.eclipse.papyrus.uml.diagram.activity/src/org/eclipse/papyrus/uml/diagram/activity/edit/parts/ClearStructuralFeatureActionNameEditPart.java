...
public class ClearStructuralFeatureActionNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "5193";
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ClearStructuralFeatureAction_3115, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
