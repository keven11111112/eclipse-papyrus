 ...
 * @generated
 */
public class ActionPinInStructuredActivityNodeAsStructuredNodeInputsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionPinInStructuredActivityNodeAsStructuredNodeInputsCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (data.isPermitted()) {
			if (data.isPathDefined()) {
				...
				qualifiedTarget.getStructuredNodeInputs().add(newElement);
			}
		} else {
			return CommandResult.newErrorCommandResult("The active policy restricts the addition of this element");
		}
		ElementInitializers.getInstance().init_ActionInputPin_3190(newElement);
