 ...
 * @generated
 */
public class ValuePinInLoopNodeAsVariableCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ValuePinInLoopNodeAsVariableCreateCommand(CreateElementRequest req, Diagram diagram) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ValuePin_3192(newElement);
