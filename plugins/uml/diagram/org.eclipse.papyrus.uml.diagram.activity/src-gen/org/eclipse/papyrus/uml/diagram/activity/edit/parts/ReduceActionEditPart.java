...
public class ReduceActionEditPart extends RoundedCompartmentEditPart {
	...
	**/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OutputPinInReduceActionEditPart) {
			...
			getBorderedFigure().getBorderItemContainer()
					.add(((OutputPinInReduceActionEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		...
		if (childEditPart instanceof InputPinInReduceActionAsCollectionEditPart) {
			...
			getBorderedFigure().getBorderItemContainer()
					.add(((InputPinInReduceActionAsCollectionEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		...
		if (childEditPart instanceof ValuePinInReduceActionAsCollectionEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.NONE);
			getBorderedFigure().getBorderItemContainer()
					.add(((ValuePinInReduceActionAsCollectionEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		...
		if (childEditPart instanceof ActionPinInReduceActionAsCollectionEditPart) {
			IBorderItemLocator locator = new PinPositionLocator(getMainFigure(), PositionConstants.NONE);
			getBorderedFigure().getBorderItemContainer()
					.add(((ActionPinInReduceActionAsCollectionEditPart) childEditPart).getFigure(), locator);
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OutputPinInReduceActionEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((OutputPinInReduceActionEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InputPinInReduceActionAsCollectionEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((InputPinInReduceActionAsCollectionEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ValuePinInReduceActionAsCollectionEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((ValuePinInReduceActionAsCollectionEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ActionPinInReduceActionAsCollectionEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((ActionPinInReduceActionAsCollectionEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
