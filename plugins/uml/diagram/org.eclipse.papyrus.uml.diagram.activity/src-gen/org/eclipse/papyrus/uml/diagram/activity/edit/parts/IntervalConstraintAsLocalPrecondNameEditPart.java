...
public class IntervalConstraintAsLocalPrecondNameEditPart extends PapyrusCompartmentEditPart
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														IntervalConstraintAsLocalPrecondNameEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.IntervalConstraint_LocalPreconditionShape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
