...
public class ParameterEditPart extends CompartmentEditPart
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(), ParameterEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Parameter_ParameterLabel, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
				...
				public void run() {
					if (isActive() && isEditable()) {
						if (request.getExtendedData().get(
							...
							Character initialChar = (Character) request.getExtendedData().get(
