...
public class OutputPinInStartObjectBehaviorActionLabelEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInStartObjectBehaviorActionLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														OutputPinInStartObjectBehaviorActionLabelEditPart.this),
												(String) value));
									}
								});
