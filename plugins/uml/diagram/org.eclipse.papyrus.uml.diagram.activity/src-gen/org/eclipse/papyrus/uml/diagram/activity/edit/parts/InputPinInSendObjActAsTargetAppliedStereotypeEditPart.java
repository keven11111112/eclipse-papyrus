...
public class InputPinInSendObjActAsTargetAppliedStereotypeEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInSendObjActAsTargetAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														InputPinInSendObjActAsTargetAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_SendObjectActionTargetShape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
