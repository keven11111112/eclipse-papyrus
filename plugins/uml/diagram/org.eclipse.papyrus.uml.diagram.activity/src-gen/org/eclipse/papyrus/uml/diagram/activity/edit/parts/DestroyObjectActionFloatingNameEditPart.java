...
public class DestroyObjectActionFloatingNameEditPart extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.DestroyObjectActionFloatingNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																DestroyObjectActionFloatingNameEditPart.this),
														(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.DestroyObjectAction_Shape, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
