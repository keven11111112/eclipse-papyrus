...
public class InputPinInReadIsClassifiedObjectActionAsObjectAppliedStereotypeLabelEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInReadIsClassifiedObjectActionAsObjectAppliedStereotypeLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(),
												InputPinInReadIsClassifiedObjectActionAsObjectAppliedStereotypeLabelEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_ReadIsClassifiedObjectActionObjectShape,
