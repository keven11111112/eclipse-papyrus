...
public class AcceptTimeEventActionAppliedStereotypeEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.activity.edit.parts.AcceptTimeEventActionAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(AppliedStereotypeLabelDisplayEditPolicy.STEREOTYPE_LABEL_POLICY,
				new AcceptTimeEventActionStereotypeExternalNodeEditPolicy());
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														AcceptTimeEventActionAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
