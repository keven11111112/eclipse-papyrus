...
public class ActionInputPinInReadLinkActionAsInputValueAppliedStereotypeLabelEditPart extends AbstractLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionInputPinInReadLinkActionAsInputValueAppliedStereotypeLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(),
												ActionInputPinInReadLinkActionAsInputValueAppliedStereotypeLabelEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ActionInputPin_ReadLinkActionInputShape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
