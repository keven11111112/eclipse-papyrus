...
public class DurationConstraintAsLocalPrecondBodyEditPart extends PapyrusCompartmentEditPart
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														DurationConstraintAsLocalPrecondBodyEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.DurationConstraint_LocalPreconditionShape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
