...
public class ValuePinInClearStructuralFeatureActionAsObjectLabelEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInClearStructuralFeatureActionAsObjectLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(),
												ValuePinInClearStructuralFeatureActionAsObjectLabelEditPart.this),
												(String) value));
									}
								});
