...
public class UMLViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		// if (domainElement != null && !visualID.equals(org.eclipse.papyrus.uml.diagram.profile.part.UMLVisualIDRegistry.getLinkWithClassVisualID(domainElement))) {
	...
	public Node createStereotype_Shape_CN(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		PreferenceInitializerForElementHelper.initFontStyleFromPrefs(node, prefStore, "Stereotype");
		Node stereotype_NameLabel_CN = createLabel(node, UMLVisualIDRegistry.getType(StereotypeNameEditPartCN.VISUAL_ID));
	...
	public Node createClass_MetaclassShape_CN(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		PreferenceInitializerForElementHelper.initFontStyleFromPrefs(node, prefStore, "Metaclass");
		Node class_MetaclassNameLabel_CN = createLabel(node, UMLVisualIDRegistry.getType(MetaclassNameEditPartCN.VISUAL_ID));
		return node;
	}
	...
	public Node createConstraint_PackagedElementShape_CN(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		Node constraint_BodyLabel_CN = createLabel(node, UMLVisualIDRegistry.getType(ConstraintBodyEditPartCN.VISUAL_ID));
		return node;
	}
