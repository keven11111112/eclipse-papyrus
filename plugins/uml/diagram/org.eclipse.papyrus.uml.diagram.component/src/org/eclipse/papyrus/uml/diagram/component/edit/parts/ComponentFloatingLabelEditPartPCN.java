 ...
 * @generated
 */
public class ComponentFloatingLabelEditPartPCN extends FloatingLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Component_3071, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
