...
public class ComponentFloatingLabelEditPartPCN extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.component.edit.parts.ComponentFloatingLabelEditPartPCN.VISUAL_ID),
				new Point(0, 0));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																ComponentFloatingLabelEditPartPCN.this),
														(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Component_PackagedElementShape_CN, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
