...
public class ActorQualifiedNameInCEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.usecase.edit.parts.ActorQualifiedNameInCEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(QualifiedNameDisplayEditPolicy.QUALIFIED_NAME_POLICY,
				new QualifiedNameDisplayExternalNodeEditPolicy());
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														ActorQualifiedNameInCEditPart.this), (String) value));
									}
								});
