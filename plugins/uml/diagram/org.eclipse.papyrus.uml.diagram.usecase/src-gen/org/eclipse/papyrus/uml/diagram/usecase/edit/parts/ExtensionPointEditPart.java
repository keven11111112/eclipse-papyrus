...
public class ExtensionPointEditPart extends CompartmentEditPart
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), ExtensionPointEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ExtensionPoint_ExtensionPointLabel, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
