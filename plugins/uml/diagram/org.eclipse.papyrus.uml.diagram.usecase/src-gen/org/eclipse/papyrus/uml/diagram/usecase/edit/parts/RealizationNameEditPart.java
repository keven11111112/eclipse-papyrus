...
public class RealizationNameEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.RealizationNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), RealizationNameEditPart.this), (String) value));
									}
								});
