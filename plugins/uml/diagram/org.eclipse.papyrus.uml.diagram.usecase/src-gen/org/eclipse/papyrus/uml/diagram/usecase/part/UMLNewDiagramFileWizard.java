...
public class UMLNewDiagramFileWizard extends Wizard {
	...
	public UMLNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		...
		myFileCreationPage.setDescription(
				NLS.bind(Messages.UMLNewDiagramFileWizard_CreationPageDescription, UseCaseDiagramEditPart.MODEL_ID));
		IPath filePath;
		...
		myFileCreationPage
				.setFileName(UMLDiagramEditorUtil.getUniqueFileName(filePath, fileName, "PapyrusUMLUsecase_diagram")); //$NON-NLS-1$
