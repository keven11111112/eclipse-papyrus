...
public class OperationTemplateParameterEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(TemplateParamaterDisplayEditPolicy.TEMPLATE_PARAMETER_DISPLAY,
				new OperationTemplateParamaterDisplayEditPolicy());
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																OperationTemplateParameterEditPart.this),
														(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.OperationTemplateParameter_TemplateParameterLabel,
