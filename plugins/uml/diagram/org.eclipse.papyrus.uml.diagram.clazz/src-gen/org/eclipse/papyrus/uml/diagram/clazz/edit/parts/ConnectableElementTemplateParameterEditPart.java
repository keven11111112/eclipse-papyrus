...
public class ConnectableElementTemplateParameterEditPart extends CompartmentEditPart
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														ConnectableElementTemplateParameterEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ConnectableElementTemplateParameter_TemplateParameterLabel,
