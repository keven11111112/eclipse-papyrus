...
public class TemplateParameterEditPart extends AbstractTemplateParameterEditPart
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), TemplateParameterEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.TemplateParameter_TemplateParameterLabel, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
