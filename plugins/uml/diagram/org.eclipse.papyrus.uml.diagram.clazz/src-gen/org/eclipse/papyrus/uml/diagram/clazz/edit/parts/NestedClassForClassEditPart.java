...
public class NestedClassForClassEditPart extends UMLCompartmentEditPart
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), NestedClassForClassEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Class_ClassNestedClassifierLabel, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
