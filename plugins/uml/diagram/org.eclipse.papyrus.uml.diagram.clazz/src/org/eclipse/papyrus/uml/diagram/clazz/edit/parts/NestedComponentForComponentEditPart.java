...
public class NestedComponentForComponentEditPart extends UMLCompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "3057";
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Component_3057, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.NestedComponentForComponentEditPart.VISUAL_ID));
		}
		return parser;
	}
