 ...
 * @generated
 */
public class OperationForPrimitiveTypeCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationForPrimitiveTypeCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static OperationForPrimitiveTypeCommand create(CreateElementRequest req, EObject eObject) {
		return new OperationForPrimitiveTypeCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public OperationForPrimitiveTypeCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
