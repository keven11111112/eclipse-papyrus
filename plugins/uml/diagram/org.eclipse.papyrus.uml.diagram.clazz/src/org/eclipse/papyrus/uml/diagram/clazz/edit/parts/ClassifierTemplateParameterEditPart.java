...
public class ClassifierTemplateParameterEditPart extends AbstractTemplateParameterEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ClassifierTemplateParameter_3031, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.ClassifierTemplateParameterEditPart.VISUAL_ID));
		}
		return parser;
	}
