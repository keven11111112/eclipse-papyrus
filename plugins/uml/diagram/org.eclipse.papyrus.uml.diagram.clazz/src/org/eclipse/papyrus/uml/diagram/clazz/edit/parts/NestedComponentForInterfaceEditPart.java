 ...
 * @generated
 */
public class NestedComponentForInterfaceEditPart extends UMLCompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Component_3056, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.NestedComponentForInterfaceEditPart.VISUAL_ID));
		}
		return parser;
	}
		...
		case IDirectEdition.EXTENDED_DIRECT_EDITOR:
			...
			if (configuration == null || configuration.getLanguage() == null) {
				...
				if (configuration instanceof ICustomDirectEditorConfiguration) {
					...
					dialog = ((IAdvancedEditorConfiguration) configuration).createDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), resolveSemanticElement(),
