 ...
 * @generated
 */
public class PrimitiveTypeCanonicalEditPolicyCN extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getPrimitiveType_3026SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getPrimitiveType_3026SemanticChildren((View)getHost().getModel());
