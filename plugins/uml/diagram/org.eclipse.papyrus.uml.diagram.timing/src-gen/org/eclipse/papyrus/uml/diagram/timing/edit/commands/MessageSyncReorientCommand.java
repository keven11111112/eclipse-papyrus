...
public class MessageSyncReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistMessage_SynchEdge(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Interaction container = (Interaction) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistMessage_SynchEdge(container, getLink(), source, getNewTarget());
	}
