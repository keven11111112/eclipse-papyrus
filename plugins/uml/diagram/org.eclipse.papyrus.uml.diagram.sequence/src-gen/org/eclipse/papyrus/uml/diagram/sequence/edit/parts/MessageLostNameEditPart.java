...
public class MessageLostNameEditPart extends PapyrusLabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageLostNameEditPart.VISUAL_ID), new Point(1, -13));
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<java.lang.Object>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), MessageLostNameEditPart.this), (String) value));
									}
								});
