 ...
 * @generated
 */
public class MessageName5EditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageName5EditPart.VISUAL_ID),
				new Point(1, -13));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<java.lang.Object>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), MessageName5EditPart.this), (String) value));
									}
								});
