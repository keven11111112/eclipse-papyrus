...
public class LocalExtendedPaletteProvider extends ExtendedPluginPaletteProvider implements IPaletteProvider {
	...
	public void setContributions(final IPaletteDescription description) {
		...
		if (paletteContributions instanceof String) {
			...
			IPath resourcePath = org.eclipse.papyrus.uml.diagram.common.Activator.getDefault().getStateLocation().append((String) description.getContributions());
	...
	private void deployLocalElementTypeModels(final String paletteID) {
		...
		File fileUI = org.eclipse.papyrus.uml.diagram.common.Activator.getDefault().getStateLocation().append(stringBuilderUI.toString()).toFile();// $NON-NLS-1$
		...
		File fileSem = org.eclipse.papyrus.uml.diagram.common.Activator.getDefault().getStateLocation().append(stringBuilderSem.toString()).toFile();
