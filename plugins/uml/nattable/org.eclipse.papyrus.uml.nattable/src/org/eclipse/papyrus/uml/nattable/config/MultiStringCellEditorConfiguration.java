...
/**
 * The cell editor configuration for the multi string value.
 */
public class MultiStringCellEditorConfiguration implements ICellAxisConfiguration {
	...
	public String getConfigurationDescription() {
		return "This configuration provides a multi editor for a multi string type"; //$NON-NLS-1$
	}
		...
		if (object instanceof EStructuralFeature) {
			...
			if (feature.isMany()) {
				...
				if (etype instanceof EDataType) {
					...
					result = TypesConstants.STRING.equals(datatype.getName()) || EMFContants.ESTRING.equals(datatype.getName());
				}
			}
		}
		return result;
