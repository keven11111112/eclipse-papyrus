...
public class UMLStereotypeMultiUMLReferenceCellEditorConfiguration extends MultiUMLReferenceCellEditorConfiguration {
	 ...
	 */
	private static final String ID = "org.eclipse.papyrus.uml.nattable.celleditor.configuration.UMLStereotypeMultiUMLReferenceCellEditorConfiguration.MultiEditor";//$NON-NLS-1$
