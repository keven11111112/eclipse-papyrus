...
/**
 * The cell editor configuration for the multi unlimited natural value.
 */
public class MultiUnlimitedNaturalCellEditorConfiguration implements ICellAxisConfiguration {

	/**
	 * The id of this editor.
	 */
	private static final String ID = "org.eclipse.papyrus.uml.nattable.celleditor.configuration.MultiUnlimitedNaturalCellEditorConfiguration.MultiEditor";//$NON-NLS-1$
	...
	public String getConfigurationDescription() {
		return "This configuration provides a multi editor for a multi Unlimited Natural type"; //$NON-NLS-1$
	}
