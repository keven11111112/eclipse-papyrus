...
/**
 * The cell editor configuration for the multi integer value.
 */
public class MultiIntegerCellEditorConfiguration implements ICellAxisConfiguration {

	/**
	 * The id of this editor.
	 */
	private static final String ID = "org.eclipse.papyrus.uml.nattable.celleditor.configuration.MultiIntegerCellEditorConfiguration.MultiEditor";//$NON-NLS-1$
	...
	public String getConfigurationDescription() {
		return "This configuration provides a multi editor for a multi integer type"; //$NON-NLS-1$
	}
		...
		if (object instanceof EStructuralFeature) {
			...
			if (feature.isMany()) {
				...
				if (etype instanceof EDataType) {
					...
					result = TypesConstants.INTEGER.equals(datatype.getName()) || EMFContants.EINT.equals(datatype.getName());
				}
			}
		}
		return result;
