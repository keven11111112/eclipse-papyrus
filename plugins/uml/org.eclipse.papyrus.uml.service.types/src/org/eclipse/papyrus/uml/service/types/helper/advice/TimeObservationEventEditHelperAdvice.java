...
import org.eclipse.papyrus.uml.service.types.command.TimeObservationEventCreateCommand;
import org.eclipse.uml2.uml.NamedElement;
import org.eclipse.uml2.uml.TimeObservation;

public class TimeObservationEventEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	protected ICommand getBeforeCreateRelationshipCommand(CreateRelationshipRequest request) {
		...
		return new TimeObservationEventCreateCommand(request);
	}
}
