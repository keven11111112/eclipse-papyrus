...
public class EnumerationLiteralHelper extends ElementEditHelper {

	@Override
	protected ICommand getBasicDestroyElementCommand(DestroyElementRequest req) {
		ICommand result =  new DestroyEnumerationLiteral(req);
	 ...
	 *
	 */
	private class DestroyEnumerationLiteral extends DestroyElementCommand{


		private Command emfcmd=null;
		public DestroyEnumerationLiteral(DestroyElementRequest request) {
			super(request);
		}
