 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.uml.types.core.advices.applystereotype.impl.ListValueImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListValueImpl extends FeatureValueImpl implements ListValue {
	...
	protected EClass eStaticClass() {
		return ApplyStereotypeAdvicePackage.Literals.LIST_VALUE;
	}
	...
	public EList<FeatureValue> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<FeatureValue>(FeatureValue.class, this, ApplyStereotypeAdvicePackage.LIST_VALUE__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApplyStereotypeAdvicePackage.LIST_VALUE__VALUES:
