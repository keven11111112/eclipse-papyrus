...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.uml.types.core.advices.applystereotype.FeatureToSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureToSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApplyStereotypeAdvicePackage.Literals.FEATURE_TO_SET__FEATURE_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApplyStereotypeAdvicePackage.Literals.FEATURE_TO_SET__VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApplyStereotypeAdvicePackage.Literals.FEATURE_TO_SET__VALUE,
				 ApplyStereotypeAdviceFactory.eINSTANCE.createListValue()));

		newChildDescriptors.add
			(createChildParameter
				(ApplyStereotypeAdvicePackage.Literals.FEATURE_TO_SET__VALUE,
				 ApplyStereotypeAdviceFactory.eINSTANCE.createConstantValue()));

		newChildDescriptors.add
			(createChildParameter
				(ApplyStereotypeAdvicePackage.Literals.FEATURE_TO_SET__VALUE,
				 ApplyStereotypeAdviceFactory.eINSTANCE.createQueryExecutionValue()));
	}
