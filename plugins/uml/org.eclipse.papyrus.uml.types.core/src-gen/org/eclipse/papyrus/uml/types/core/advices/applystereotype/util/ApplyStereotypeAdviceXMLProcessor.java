...
public class ApplyStereotypeAdviceXMLProcessor extends XMLProcessor {
	...
	/**
	 * Register for "*" and "xml" file extensions the ApplyStereotypeAdviceResourceFactoryImpl factory.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected Map<String, Resource.Factory> getRegistrations() {
		if (registrations == null) {
			...
			registrations.put(XML_EXTENSION, new ApplyStereotypeAdviceResourceFactoryImpl());
			registrations.put(STAR_EXTENSION, new ApplyStereotypeAdviceResourceFactoryImpl());
		}
		return registrations;
	}

} //ApplyStereotypeAdviceXMLProcessor
