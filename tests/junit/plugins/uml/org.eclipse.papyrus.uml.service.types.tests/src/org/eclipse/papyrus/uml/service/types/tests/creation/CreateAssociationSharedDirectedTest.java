...
public class CreateAssociationSharedDirectedTest extends AbstractCreateAssociationTest {

	/**
	 * The element id corresponding to the non-directed association.
	 */
	private static final String ELEMENT_TYPE_ID = "org.eclipse.papyrus.uml.AssociationSharedDirected";
	...
	public void testCreation() throws InterruptedException, RollbackException {
		...
		Assert.assertEquals("The first Association member end must not have aggregation kind", AggregationKind.SHARED_LITERAL, memberEnds.get(0).getAggregation());
