...
public class CreateAssociationSharedTest extends AbstractCreateAssociationTest {

	/**
	 * The element id corresponding to the non-directed association.
	 */
	private static final String ELEMENT_TYPE_ID = "org.eclipse.papyrus.uml.AssociationShared";
