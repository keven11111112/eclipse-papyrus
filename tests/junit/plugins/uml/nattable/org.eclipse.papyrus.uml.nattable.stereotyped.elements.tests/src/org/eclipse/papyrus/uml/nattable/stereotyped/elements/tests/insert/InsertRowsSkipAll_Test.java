...
public class InsertRowsSkipAll_Test extends AbstractInsertRowsTest {
	...
	/**
	 * @see org.eclipse.papyrus.uml.nattable.stereotyped.elements.tests.paste.overwrite.AbstractPasteInsertTest#testUndo_Redo(org.eclipse.papyrus.infra.nattable.manager.table.NattableModelManager)
	 *
	 * @param treeManager
	 * @throws Exception
	 */
