...
/**
 * Test the genericTreeTable nattable model :
 *  - validate the model
 * 
 * @author Benoit Maggi
 */
public class GenericTreeTableNattableConfigurationTest extends AbstractPapyrusTest{
	...
	public void validateGenericTreeTableConfigurationModel() {
		...
		Assert.assertEquals("The genericTreeTable.nattableconfiguration model is not valid ", Diagnostic.OK, diagnostic.getSeverity());
	}
}
