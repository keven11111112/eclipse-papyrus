...
public class DialogInteractionRule extends TestWatcher {
	...
	private final AtomicReference<Boolean> interactionResult = new AtomicReference<Boolean>();
	...
	protected void starting(Description description) {
		interactionMode = getAnnotation(description, DialogInteractionMode.class).value();
		active = true;
	...
	static <A extends Annotation> A getAnnotation(Description description, Class<A> type) {
