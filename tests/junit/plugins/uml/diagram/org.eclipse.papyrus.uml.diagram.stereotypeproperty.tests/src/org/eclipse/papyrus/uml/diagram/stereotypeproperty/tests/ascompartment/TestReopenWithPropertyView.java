 ...
 * Verify requirements org.eclipse.papyrus.uml.diagram.stereotype.edition.REQ_0042
 * -The user can choose the applied stereotype properties to display by using the property view
 */
@PluginResource({ TestReopenWithPropertyView.MODEL_DI })
public class TestReopenWithPropertyView extends AbstractPapyrusTestCase {
	/** name of the test project */
	public final String PROJECT_NAME = "TestReopenWithPropertyViewProject";

	/** name of the test model */
	public final String FILE_NAME = "TestReopenWithPropertyView.di";

	final static String MODEL_DI = "resource/ReopenFileWithCSS.di"; //$NON-NLS-1$
