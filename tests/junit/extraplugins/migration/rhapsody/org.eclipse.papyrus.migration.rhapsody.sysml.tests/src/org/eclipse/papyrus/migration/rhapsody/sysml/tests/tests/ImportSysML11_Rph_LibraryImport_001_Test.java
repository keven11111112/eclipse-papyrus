 ...
 *
 */
@PluginResource("resources/Rph_LibraryImport_001/expected_papyrus/Rph_LibraryImport_001.di") // the name of the expected model must be the same than the name of the Rhapsody project
public class ImportSysML11_Rph_LibraryImport_001_Test extends AbstractImportRhapsodyModelTests {

	/**
	 * the name of the Rhapsody File
	 */
	public static final String RHAPSODY_MODEL_NAME = "Rph_LibraryImport_001"; //$NON-NLS-1$
