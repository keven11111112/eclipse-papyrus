...
public class SwitchCollectTest extends BaseTest {
	...
	public static IUnaryFunction<Integer, IOne<Boolean>> isOdd = new IUnaryFunction<Integer, IOne<Boolean>>() {
	...
	public static IUnaryFunction<Integer, IOne<Boolean>> isEven = new IUnaryFunction<Integer, IOne<Boolean>>() {
		private Map<Integer, IOne<Boolean>> cache = new HashMap<Integer, IOne<Boolean>>();
