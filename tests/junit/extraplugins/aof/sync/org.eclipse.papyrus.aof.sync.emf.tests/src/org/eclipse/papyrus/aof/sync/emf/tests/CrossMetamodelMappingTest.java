...
/**
 * Test cases for the mappings from one metamodel to another.
 */
@RunWith(GuiceRunner.class)
@InjectWith({ UML2EcoreMappingModule.class })
public class CrossMetamodelMappingTest {
	@Rule
	...
	public CrossMetamodelMappingTest() {
		super();
	}
	...
	public void undoMapping() {
		...
		set(fromClass, UMLPackage.Literals.NAMED_ELEMENT__NAME, "Bar");
