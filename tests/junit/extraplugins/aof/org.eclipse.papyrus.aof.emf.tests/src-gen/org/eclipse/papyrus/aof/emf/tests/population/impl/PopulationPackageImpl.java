...
public class PopulationPackageImpl extends EPackageImpl implements PopulationPackage {
	 ...
	 * @see org.eclipse.papyrus.aof.emf.tests.population.PopulationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPerson_Favorite() {
	 ...
	 * @generated
	 */
	public EAttribute getPerson_LockerCombination() {
	 ...
	 * @generated
	 */
	public EReference getPerson_Acquaintances() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__FAVORITE);
		createEAttribute(personEClass, PERSON__LOCKER_COMBINATION);
		createEReference(personEClass, PERSON__ACQUAINTANCES);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_Name(), ecorePackage.getEString(), "name", "Name", 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_Parent(), this.getPerson(), this.getPerson_Children(), "parent", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_Children(), this.getPerson(), this.getPerson_Parent(), "children", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPerson_Favorite(), this.getPerson(), null, "favorite", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_LockerCombination(), ecorePackage.getEInt(), "lockerCombination", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_Acquaintances(), this.getPerson(), null, "acquaintances", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
