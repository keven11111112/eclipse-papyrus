...
public class RevealViewsTableTest extends AbstractEditorTest {
	...
	public void test1_SelectElement() {
		...
		if(this.editor.getActiveEditor() instanceof IRevealSemanticElement) {
			((IRevealSemanticElement)this.editor.getActiveEditor()).revealSemanticElement(Collections.singletonList(this.diagramTest1));
	...
	public void test3_SelectMultipleElements() {
		...
		if(this.editor.getActiveEditor() instanceof IRevealSemanticElement) {
			((IRevealSemanticElement)this.editor.getActiveEditor()).revealSemanticElement(this.viewsListTest);
			ISelectionService serv = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getSelectionService();
			final ISelection selection = serv.getSelection();
			if(selection instanceof IStructuredSelection) {
