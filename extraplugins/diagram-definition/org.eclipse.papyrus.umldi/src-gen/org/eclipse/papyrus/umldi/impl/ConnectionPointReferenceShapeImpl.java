...
public class ConnectionPointReferenceShapeImpl extends ElementShapeImpl implements ConnectionPointReferenceShape {
	...
	public StateShape getStateShape() {
		if (eContainerFeatureID() != UMLDIPackage.CONNECTION_POINT_REFERENCE_SHAPE__STATE_SHAPE) return null;
	...
	public boolean isSetOwningUmlDiagramElement() {
		return super.isSetOwningUmlDiagramElement()
			|| eIsSet(UMLDIPackage.CONNECTION_POINT_REFERENCE_SHAPE__STATE_SHAPE);
	}
