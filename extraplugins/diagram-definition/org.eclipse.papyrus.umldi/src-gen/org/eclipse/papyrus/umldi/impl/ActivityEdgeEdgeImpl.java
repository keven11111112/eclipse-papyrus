 ...
 * @generated
 */
public abstract class ActivityEdgeEdgeImpl extends RelationshipWithGuardEdgeImpl implements ActivityEdgeEdge {
	/**
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_UML_DIAGRAM_ELEMENT_ESUBSETS = new int[] {UMLDIPackage.ACTIVITY_EDGE_EDGE__MAIN_LABEL, UMLDIPackage.ACTIVITY_EDGE_EDGE__GUARD_LABEL, UMLDIPackage.ACTIVITY_EDGE_EDGE__WEIGHT_LABEL};
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.ACTIVITY_EDGE_EDGE__WEIGHT_LABEL);
	}
