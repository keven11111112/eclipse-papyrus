...
public class UMLDIFactoryImpl extends EFactoryImpl implements UMLDIFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UMLDIPackage.MAIN_LABEL: return createMainLabel();
			case UMLDIPackage.CLASS_DIAGRAM: return createClassDiagram();
			case UMLDIPackage.TEMPLATE_PARAMETER_COMPARTMENT: return createTemplateParameterCompartment();
			case UMLDIPackage.LIST_ITEM_LABEL: return createListItemLabel();
			case UMLDIPackage.OWNED_USE_CASE_COMPARTMENT: return createOwnedUseCaseCompartment();
			case UMLDIPackage.USE_CASE_COMPARTMENT: return createUseCaseCompartment();
			case UMLDIPackage.PACKAGE_SHAPE: return createPackageShape();
			case UMLDIPackage.PACKAGED_ELEMENT_COMPARTMENT: return createPackagedElementCompartment();
			case UMLDIPackage.CONSTRAINT_SHAPE: return createConstraintShape();
			case UMLDIPackage.BODY_LABEL: return createBodyLabel();
			case UMLDIPackage.ATTRIBUTE_COMPARTMENT: return createAttributeCompartment();
			case UMLDIPackage.OPERATION_COMPARTMENT: return createOperationCompartment();
			case UMLDIPackage.RECEPTION_COMPARTMENT: return createReceptionCompartment();
			case UMLDIPackage.LITERAL_COMPARTMENT: return createLiteralCompartment();
			case UMLDIPackage.ENUMERATION_SHAPE: return createEnumerationShape();
			case UMLDIPackage.ROLE_LABEL: return createRoleLabel();
			case UMLDIPackage.ASSOCIATION_EDGE: return createAssociationEdge();
			case UMLDIPackage.MULTIPLICITY_LABEL: return createMultiplicityLabel();
			case UMLDIPackage.PROPERTY_EDGE: return createPropertyEdge();
			case UMLDIPackage.CONSTRAINT_LABEL: return createConstraintLabel();
			case UMLDIPackage.GENERALIZATION_SET_EDGE: return createGeneralizationSetEdge();
			case UMLDIPackage.POWER_LABEL: return createPowerLabel();
			case UMLDIPackage.OBJECT_NODE_SHAPE: return createObjectNodeShape();
			case UMLDIPackage.ACTIVITY_NODE_SHAPE: return createActivityNodeShape();
			case UMLDIPackage.SELECTION_LABEL: return createSelectionLabel();
			case UMLDIPackage.OBJECT_FLOW_EDGE: return createObjectFlowEdge();
			case UMLDIPackage.GUARD_LABEL: return createGuardLabel();
			case UMLDIPackage.WEIGHT_LABEL: return createWeightLabel();
			case UMLDIPackage.TRANSFORMATION_LABEL: return createTransformationLabel();
			case UMLDIPackage.CONNECTOR_EDGE: return createConnectorEdge();
			case UMLDIPackage.INSTANCE_SPECIFICATION_EDGE: return createInstanceSpecificationEdge();
			case UMLDIPackage.DEPENDENCY_EDGE: return createDependencyEdge();
			case UMLDIPackage.INSTANCE_SPECIFICATION_SHAPE: return createInstanceSpecificationShape();
			case UMLDIPackage.DEPLOYED_ARTIFACT_COMPARTMENT: return createDeployedArtifactCompartment();
			case UMLDIPackage.SLOT_COMPARTMENT: return createSlotCompartment();
			case UMLDIPackage.CLASS_SHAPE: return createClassShape();
			case UMLDIPackage.INTERNAL_STRUCTURE_COMPARTMENT: return createInternalStructureCompartment();
			case UMLDIPackage.PORT_SHAPE: return createPortShape();
			case UMLDIPackage.NESTED_CLASSIFIER_COMPARTMENT: return createNestedClassifierCompartment();
			case UMLDIPackage.OWNED_BEHAVIOR_COMPARTMENT: return createOwnedBehaviorCompartment();
			case UMLDIPackage.INTERFACE_SHAPE: return createInterfaceShape();
			case UMLDIPackage.DATA_TYPE_SHAPE: return createDataTypeShape();
			case UMLDIPackage.PRIMITIVE_TYPE_SHAPE: return createPrimitiveTypeShape();
			case UMLDIPackage.SIGNAL_SHAPE: return createSignalShape();
			case UMLDIPackage.MODEL_SHAPE: return createModelShape();
			case UMLDIPackage.CONTAINMENT_EDGE: return createContainmentEdge();
			case UMLDIPackage.GENERALIZATION_EDGE: return createGeneralizationEdge();
			case UMLDIPackage.REALIZATION_EDGE: return createRealizationEdge();
			case UMLDIPackage.ABSTRACTION_EDGE: return createAbstractionEdge();
			case UMLDIPackage.INTERFACE_REALIZATION_EDGE: return createInterfaceRealizationEdge();
			case UMLDIPackage.USAGE_EDGE: return createUsageEdge();
			case UMLDIPackage.ELEMENT_IMPORT_EDGE: return createElementImportEdge();
			case UMLDIPackage.PACKAGE_IMPORT_EDGE: return createPackageImportEdge();
			case UMLDIPackage.PACKAGE_MERGE_EDGE: return createPackageMergeEdge();
			case UMLDIPackage.SUBSTITUTION_EDGE: return createSubstitutionEdge();
			case UMLDIPackage.INFORMATION_FLOW_EDGE: return createInformationFlowEdge();
			case UMLDIPackage.CONVEYED_LABEL: return createConveyedLabel();
			case UMLDIPackage.ASSOCIATION_CLASS_EDGE: return createAssociationClassEdge();
			case UMLDIPackage.COMMENT_SHAPE: return createCommentShape();
			case UMLDIPackage.ATTACHMENT_EDGE: return createAttachmentEdge();
			case UMLDIPackage.ASSOCIATION_CLASS_SHAPE: return createAssociationClassShape();
			case UMLDIPackage.COMPONENT_SHAPE: return createComponentShape();
			case UMLDIPackage.INFORMATION_ITEM_SHAPE: return createInformationItemShape();
			case UMLDIPackage.REPRESENTATION_EDGE: return createRepresentationEdge();
			case UMLDIPackage.ASSOCIATION_SHAPE: return createAssociationShape();
			case UMLDIPackage.DEPENDENCY_SHAPE: return createDependencyShape();
			case UMLDIPackage.TIME_OBSERVATION_SHAPE: return createTimeObservationShape();
			case UMLDIPackage.DURATION_OBSERVATION_SHAPE: return createDurationObservationShape();
			case UMLDIPackage.PACKAGE_DIAGRAM: return createPackageDiagram();
			case UMLDIPackage.PROFILE_DIAGRAM: return createProfileDiagram();
			case UMLDIPackage.COMPOSITE_STRUCTURE_DIAGRAM: return createCompositeStructureDiagram();
			case UMLDIPackage.DEPLOYMENT_DIAGRAM: return createDeploymentDiagram();
			case UMLDIPackage.COMPONENT_DIAGRAM: return createComponentDiagram();
			case UMLDIPackage.OBJECT_DIAGRAM: return createObjectDiagram();
			case UMLDIPackage.PROFILE_SHAPE: return createProfileShape();
			case UMLDIPackage.PROFILE_APPLICATION_EDGE: return createProfileApplicationEdge();
			case UMLDIPackage.EXTENSION_EDGE: return createExtensionEdge();
			case UMLDIPackage.USE_CASE_DIAGRAM: return createUseCaseDiagram();
			case UMLDIPackage.ARTIFACT_SHAPE: return createArtifactShape();
			case UMLDIPackage.NESTED_ARTIFACT_COMPARTMENT: return createNestedArtifactCompartment();
			case UMLDIPackage.COMPONENT_REALIZATION_EDGE: return createComponentRealizationEdge();
			case UMLDIPackage.MANIFESTATION_EDGE: return createManifestationEdge();
			case UMLDIPackage.PROPERTY_SHAPE: return createPropertyShape();
			case UMLDIPackage.COLLABORATION_SHAPE: return createCollaborationShape();
			case UMLDIPackage.COLLABORATION_USE_SHAPE: return createCollaborationUseShape();
			case UMLDIPackage.TEMPLATE_BINDING_EDGE: return createTemplateBindingEdge();
			case UMLDIPackage.STEREOTYPE_SHAPE: return createStereotypeShape();
			case UMLDIPackage.NODE_SHAPE: return createNodeShape();
			case UMLDIPackage.NESTED_NODE_COMPARTMENT: return createNestedNodeCompartment();
			case UMLDIPackage.DEVICE_SHAPE: return createDeviceShape();
			case UMLDIPackage.EXECUTION_ENVIRONMENT_SHAPE: return createExecutionEnvironmentShape();
			case UMLDIPackage.ACTIVITY_SHAPE: return createActivityShape();
			case UMLDIPackage.PARAMETER_COMPARTMENT: return createParameterCompartment();
			case UMLDIPackage.POST_CONDITION_COMPARTMENT: return createPostConditionCompartment();
			case UMLDIPackage.PRE_CONDITION_COMPARTMENT: return createPreConditionCompartment();
			case UMLDIPackage.CONTENT_COMPARTMENT: return createContentCompartment();
			case UMLDIPackage.STRUCTURED_ACTIVITY_NODE_SHAPE: return createStructuredActivityNodeShape();
			case UMLDIPackage.ACTION_SHAPE: return createActionShape();
			case UMLDIPackage.PIN_SHAPE: return createPinShape();
			case UMLDIPackage.ACTIVITY_GROUP_SHAPE: return createActivityGroupShape();
			case UMLDIPackage.ACTIVITY_PARAMETER_NODE_SHAPE: return createActivityParameterNodeShape();
			case UMLDIPackage.INTERACTION_SHAPE: return createInteractionShape();
			case UMLDIPackage.OPAQUE_BEHAVIOR_SHAPE: return createOpaqueBehaviorShape();
			case UMLDIPackage.FUNCTION_BEHAVIOR_SHAPE: return createFunctionBehaviorShape();
			case UMLDIPackage.STATE_MACHINE_SHAPE: return createStateMachineShape();
			case UMLDIPackage.PSEUDOSTATE_SHAPE: return createPseudostateShape();
			case UMLDIPackage.REGION_COMPARTMENT: return createRegionCompartment();
			case UMLDIPackage.PROTOCOL_STATE_MACHINE_SHAPE: return createProtocolStateMachineShape();
			case UMLDIPackage.DEPLOYMENT_SPECIFICATION_SHAPE: return createDeploymentSpecificationShape();
			case UMLDIPackage.COMMUNICATION_PATH_EDGE: return createCommunicationPathEdge();
			case UMLDIPackage.DEPLOYMENT_EDGE: return createDeploymentEdge();
			case UMLDIPackage.ACTOR_SHAPE: return createActorShape();
			case UMLDIPackage.EXTENSION_POINT_COMPARTMENT: return createExtensionPointCompartment();
			case UMLDIPackage.USE_CASE_SHAPE: return createUseCaseShape();
			case UMLDIPackage.INCLUDE_EDGE: return createIncludeEdge();
			case UMLDIPackage.EXTEND_EDGE: return createExtendEdge();
			case UMLDIPackage.STATE_MACHINE_DIAGRAM: return createStateMachineDiagram();
			case UMLDIPackage.ACTIVITY_DIAGRAM: return createActivityDiagram();
			case UMLDIPackage.SEQUENCE_DIAGRAM: return createSequenceDiagram();
			case UMLDIPackage.COMMUNICATION_DIAGRAM: return createCommunicationDiagram();
			case UMLDIPackage.TIMING_DIAGRAM: return createTimingDiagram();
			case UMLDIPackage.INTERACTION_OVERVIEW_DIAGRAM: return createInteractionOverviewDiagram();
			case UMLDIPackage.INTERNAL_BEHAVIOR_COMPARTMENT: return createInternalBehaviorCompartment();
			case UMLDIPackage.STATE_SHAPE: return createStateShape();
			case UMLDIPackage.CONNECTION_POINT_REFERENCE_SHAPE: return createConnectionPointReferenceShape();
			case UMLDIPackage.INTERNAL_TRANSITION_COMPARTMENT: return createInternalTransitionCompartment();
			case UMLDIPackage.DEFERRABLE_TRIGGER_COMPARTMENT: return createDeferrableTriggerCompartment();
			case UMLDIPackage.REGION_SHAPE: return createRegionShape();
			case UMLDIPackage.SUBVERTEX_COMPARTMENT: return createSubvertexCompartment();
			case UMLDIPackage.TRANSITION_EDGE: return createTransitionEdge();
			case UMLDIPackage.CONTROL_FLOW_EDGE: return createControlFlowEdge();
			case UMLDIPackage.EXCEPTION_HANDLER_EDGE: return createExceptionHandlerEdge();
			case UMLDIPackage.TYPE_LABEL: return createTypeLabel();
			case UMLDIPackage.ICON_LABEL: return createIconLabel();
			case UMLDIPackage.SUB_PARTITION_COMPARTMENT: return createSubPartitionCompartment();
			case UMLDIPackage.ACTIVITY_PARTITION_SHAPE: return createActivityPartitionShape();
			case UMLDIPackage.EXPANSION_REGION_SHAPE: return createExpansionRegionShape();
			case UMLDIPackage.EXPANSION_NODE_SHAPE: return createExpansionNodeShape();
			default:
	 ...
	 * @generated
	 */
	public InternalStructureCompartment createInternalStructureCompartment() {
		InternalStructureCompartmentImpl internalStructureCompartment = new InternalStructureCompartmentImpl();
	 ...
	 * @generated
	 */
	public ContentCompartment createContentCompartment() {
		ContentCompartmentImpl contentCompartment = new ContentCompartmentImpl();
