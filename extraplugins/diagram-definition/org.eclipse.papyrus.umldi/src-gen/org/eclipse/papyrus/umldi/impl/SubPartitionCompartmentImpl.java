...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sub Partition Compartment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SubPartitionCompartmentImpl extends DiagramCompartmentImpl implements SubPartitionCompartment {
	...
	protected EClass eStaticClass() {
		return UMLDIPackage.Literals.SUB_PARTITION_COMPARTMENT;
	}
	...
	public ActivityPartitionShape getActivityPartitionShape() {
		if (eContainerFeatureID() != UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE) return null;
	...
	public NotificationChain basicSetActivityPartitionShape(ActivityPartitionShape newActivityPartitionShape, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newActivityPartitionShape, UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE, msgs);
		return msgs;
	}
	...
	public void setActivityPartitionShape(ActivityPartitionShape newActivityPartitionShape) {
		if (newActivityPartitionShape != eInternalContainer() || (eContainerFeatureID() != UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE && newActivityPartitionShape != null)) {
			...
			if (newActivityPartitionShape != null)
				msgs = ((InternalEObject)newActivityPartitionShape).eInverseAdd(this, UMLDIPackage.ACTIVITY_PARTITION_SHAPE__SUB_PARTITION_COMPARTMENT, ActivityPartitionShape.class, msgs);
			msgs = basicSetActivityPartitionShape(newActivityPartitionShape, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE, newActivityPartitionShape, newActivityPartitionShape));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE:
				return eInternalContainer().eInverseRemove(this, UMLDIPackage.ACTIVITY_PARTITION_SHAPE__SUB_PARTITION_COMPARTMENT, ActivityPartitionShape.class, msgs);
		}
	...
	public boolean isSetOwningUmlDiagramElement() {
		return super.isSetOwningUmlDiagramElement()
			|| eIsSet(UMLDIPackage.SUB_PARTITION_COMPARTMENT__ACTIVITY_PARTITION_SHAPE);
	}
