...
public class NodeShapeImpl extends ClassShapeImpl implements NodeShape {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DeploymentTargetShape.class) {
			switch (derivedFeatureID) {
				case UMLDIPackage.NODE_SHAPE__DEPLOYED_ARTIFACT_COMPARTMENT: return UMLDIPackage.DEPLOYMENT_TARGET_SHAPE__DEPLOYED_ARTIFACT_COMPARTMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DeploymentTargetShape.class) {
			switch (baseFeatureID) {
				case UMLDIPackage.DEPLOYMENT_TARGET_SHAPE__DEPLOYED_ARTIFACT_COMPARTMENT: return UMLDIPackage.NODE_SHAPE__DEPLOYED_ARTIFACT_COMPARTMENT;
				default: return -1;
			}
		}
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.NODE_SHAPE__DEPLOYED_ARTIFACT_COMPARTMENT)
			|| eIsSet(UMLDIPackage.NODE_SHAPE__NESTED_NODE_COMPARTMENT);
	}
