...
public interface UseCaseShape extends BehavioredClassifierShape {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Extension Point Compartment</em>' containment reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.umldi.UseCaseShape#getExtensionPointCompartment <em>Extension Point Compartment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Extension Point Compartment</em>' containment reference.
