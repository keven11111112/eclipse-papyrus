...
public class DeployedArtifactCompartmentImpl extends ClassifierCompartmentImpl implements DeployedArtifactCompartment {
	...
	public DeploymentTargetShape getDeploymentTargetShape() {
		if (eContainerFeatureID() != UMLDIPackage.DEPLOYED_ARTIFACT_COMPARTMENT__DEPLOYMENT_TARGET_SHAPE) return null;
	...
	public boolean isSetOwningUmlDiagramElement() {
		return super.isSetOwningUmlDiagramElement()
			|| eIsSet(UMLDIPackage.DEPLOYED_ARTIFACT_COMPARTMENT__DEPLOYMENT_TARGET_SHAPE);
	}
