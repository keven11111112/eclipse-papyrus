...
public class ExpansionRegionShapeImpl extends StructuredActivityNodeShapeImpl implements ExpansionRegionShape {
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_UML_DIAGRAM_ELEMENT_ESUBSETS = new int[] {UMLDIPackage.EXPANSION_REGION_SHAPE__MAIN_LABEL, UMLDIPackage.EXPANSION_REGION_SHAPE__PIN_SHAPE, UMLDIPackage.EXPANSION_REGION_SHAPE__CONTENT_COMPARTMENT, UMLDIPackage.EXPANSION_REGION_SHAPE__EXPANSION_NODE_SHAPE};
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.EXPANSION_REGION_SHAPE__EXPANSION_NODE_SHAPE);
	}
