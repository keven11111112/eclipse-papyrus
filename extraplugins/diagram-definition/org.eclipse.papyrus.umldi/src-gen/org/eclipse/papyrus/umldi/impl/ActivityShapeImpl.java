 ...
 *   <li>{@link org.eclipse.papyrus.umldi.impl.ActivityShapeImpl#getContentCompartment <em>Content Compartment</em>}</li>
...
public class ActivityShapeImpl extends ClassShapeImpl implements ActivityShape {
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_UML_DIAGRAM_ELEMENT_ESUBSETS = new int[] {UMLDIPackage.ACTIVITY_SHAPE__MAIN_LABEL, UMLDIPackage.ACTIVITY_SHAPE__TEMPLATE_PARAMETER_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__OWNED_USE_CASE_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__USE_CASE_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__ATTRIBUTE_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__OPERATION_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__RECEPTION_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__NESTED_CLASSIFIER_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__OWNED_BEHAVIOR_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__INTERNAL_STRUCTURE_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__PORT_SHAPE, UMLDIPackage.ACTIVITY_SHAPE__PARAMETER_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__POST_CONDITION_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__PRE_CONDITION_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT, UMLDIPackage.ACTIVITY_SHAPE__ACTIVITY_PARAMETER_NODE_SHAPE};
	...
	public NotificationChain basicSetContentCompartment(ContentCompartment newContentCompartment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT, oldContentCompartment, newContentCompartment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContentCompartment(ContentCompartment newContentCompartment) {
		if (newContentCompartment != contentCompartment) {
			...
			if (contentCompartment != null)
				msgs = ((InternalEObject)contentCompartment).eInverseRemove(this, UMLDIPackage.CONTENT_COMPARTMENT__ACTIVITY_SHAPE, ContentCompartment.class, msgs);
			if (newContentCompartment != null)
				msgs = ((InternalEObject)newContentCompartment).eInverseAdd(this, UMLDIPackage.CONTENT_COMPARTMENT__ACTIVITY_SHAPE, ContentCompartment.class, msgs);
			msgs = basicSetContentCompartment(newContentCompartment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT, newContentCompartment, newContentCompartment));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT:
				if (contentCompartment != null)
					msgs = ((InternalEObject)contentCompartment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT, null, msgs);
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.ACTIVITY_SHAPE__PARAMETER_COMPARTMENT)
			|| eIsSet(UMLDIPackage.ACTIVITY_SHAPE__POST_CONDITION_COMPARTMENT)
			|| eIsSet(UMLDIPackage.ACTIVITY_SHAPE__PRE_CONDITION_COMPARTMENT)
			|| eIsSet(UMLDIPackage.ACTIVITY_SHAPE__CONTENT_COMPARTMENT)
