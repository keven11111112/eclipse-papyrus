...
public abstract class ClassifierShapeImpl extends TemplateableElementShapeImpl implements ClassifierShape {
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_UML_DIAGRAM_ELEMENT_ESUBSETS = new int[] {UMLDIPackage.CLASSIFIER_SHAPE__MAIN_LABEL, UMLDIPackage.CLASSIFIER_SHAPE__TEMPLATE_PARAMETER_COMPARTMENT, UMLDIPackage.CLASSIFIER_SHAPE__OWNED_USE_CASE_COMPARTMENT, UMLDIPackage.CLASSIFIER_SHAPE__USE_CASE_COMPARTMENT};
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.CLASSIFIER_SHAPE__OWNED_USE_CASE_COMPARTMENT)
			|| eIsSet(UMLDIPackage.CLASSIFIER_SHAPE__USE_CASE_COMPARTMENT);
	}
