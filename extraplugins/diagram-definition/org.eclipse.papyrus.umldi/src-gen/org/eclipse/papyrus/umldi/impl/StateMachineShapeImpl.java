...
public class StateMachineShapeImpl extends ClassShapeImpl implements StateMachineShape {
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_UML_DIAGRAM_ELEMENT_ESUBSETS = new int[] {UMLDIPackage.STATE_MACHINE_SHAPE__MAIN_LABEL, UMLDIPackage.STATE_MACHINE_SHAPE__TEMPLATE_PARAMETER_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__OWNED_USE_CASE_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__USE_CASE_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__ATTRIBUTE_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__OPERATION_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__RECEPTION_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__NESTED_CLASSIFIER_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__OWNED_BEHAVIOR_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__INTERNAL_STRUCTURE_COMPARTMENT, UMLDIPackage.STATE_MACHINE_SHAPE__PORT_SHAPE, UMLDIPackage.STATE_MACHINE_SHAPE__CONNECTION_POINT_SHAPE, UMLDIPackage.STATE_MACHINE_SHAPE__REGION_COMPARTMENT};
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BaseStateShape.class) {
			switch (derivedFeatureID) {
				case UMLDIPackage.STATE_MACHINE_SHAPE__CONNECTION_POINT_SHAPE: return UMLDIPackage.BASE_STATE_SHAPE__CONNECTION_POINT_SHAPE;
				case UMLDIPackage.STATE_MACHINE_SHAPE__REGION_COMPARTMENT: return UMLDIPackage.BASE_STATE_SHAPE__REGION_COMPARTMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BaseStateShape.class) {
			switch (baseFeatureID) {
				case UMLDIPackage.BASE_STATE_SHAPE__CONNECTION_POINT_SHAPE: return UMLDIPackage.STATE_MACHINE_SHAPE__CONNECTION_POINT_SHAPE;
				case UMLDIPackage.BASE_STATE_SHAPE__REGION_COMPARTMENT: return UMLDIPackage.STATE_MACHINE_SHAPE__REGION_COMPARTMENT;
				default: return -1;
			}
		}
	...
	public boolean isSetOwnedUmlDiagramElement() {
		return super.isSetOwnedUmlDiagramElement()
			|| eIsSet(UMLDIPackage.STATE_MACHINE_SHAPE__CONNECTION_POINT_SHAPE)
			|| eIsSet(UMLDIPackage.STATE_MACHINE_SHAPE__REGION_COMPARTMENT);
	}
