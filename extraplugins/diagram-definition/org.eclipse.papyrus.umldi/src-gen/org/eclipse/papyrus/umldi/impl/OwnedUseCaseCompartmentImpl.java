...
public class OwnedUseCaseCompartmentImpl extends ClassifierCompartmentImpl implements OwnedUseCaseCompartment {
	...
	public ClassifierShape getClassifierShape() {
		if (eContainerFeatureID() != UMLDIPackage.OWNED_USE_CASE_COMPARTMENT__CLASSIFIER_SHAPE) return null;
	...
	public boolean isSetOwningUmlDiagramElement() {
		return super.isSetOwningUmlDiagramElement()
			|| eIsSet(UMLDIPackage.OWNED_USE_CASE_COMPARTMENT__CLASSIFIER_SHAPE);
	}
