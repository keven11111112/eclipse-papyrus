...
public interface NodeShape extends ClassShape, DeploymentTargetShape {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Nested Node Compartment</em>' containment reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.umldi.NodeShape#getNestedNodeCompartment <em>Nested Node Compartment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Nested Node Compartment</em>' containment reference.
