 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.aof.emf.samples.tests.impl.TestImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestImpl extends MinimalEObjectImpl.Container implements Test {
	...
	protected EClass eStaticClass() {
		return TestsPackage.Literals.TEST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestsPackage.TEST__NAME, oldName, name));
	}
