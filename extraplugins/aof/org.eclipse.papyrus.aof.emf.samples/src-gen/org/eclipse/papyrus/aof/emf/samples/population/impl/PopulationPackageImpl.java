...
import org.eclipse.papyrus.aof.emf.samples.population.Population;
import org.eclipse.papyrus.aof.emf.samples.population.PopulationFactory;
...
public class PopulationPackageImpl extends EPackageImpl implements PopulationPackage {
	 ...
	 * @see org.eclipse.papyrus.aof.emf.samples.population.PopulationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPerson_Spouse() {
	 ...
	 * @generated
	 */
	public EReference getPopulation_Persons() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__SPOUSE);

		populationEClass = createEClass(POPULATION);
		createEReference(populationEClass, POPULATION__PERSONS);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getPerson_Spouse(), this.getPerson(), null, "spouse", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(populationEClass, Population.class, "Population", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPopulation_Persons(), this.getPerson(), null, "persons", null, 0, -1, Population.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
