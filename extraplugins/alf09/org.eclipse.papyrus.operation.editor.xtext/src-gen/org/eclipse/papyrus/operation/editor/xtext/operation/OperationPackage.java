...
public interface OperationPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.papyrus.operation.editor.xtext.operation.OperationDeclaration#isIsConstructor <em>Is Constructor</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Is Constructor</em>'.
   * @see org.eclipse.papyrus.operation.editor.xtext.operation.OperationDeclaration#isIsConstructor()
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.papyrus.operation.editor.xtext.operation.OperationDeclaration#isIsDestructor <em>Is Destructor</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Is Destructor</em>'.
   * @see org.eclipse.papyrus.operation.editor.xtext.operation.OperationDeclaration#isIsDestructor()
   * @see #getOperationDeclaration()
   * @generated
   */
