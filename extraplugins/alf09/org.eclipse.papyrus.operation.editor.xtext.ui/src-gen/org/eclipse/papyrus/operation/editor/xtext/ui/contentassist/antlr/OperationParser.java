		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationDeclarationAccess().getAlternatives_0(), "rule__OperationDeclaration__Alternatives_0");
					...
					put(grammarAccess.getOperationDeclarationAccess().getGroup_5(), "rule__OperationDeclaration__Group_5__0");
					...
					put(grammarAccess.getOperationDeclarationAccess().getIsConstructorAssignment_0_0(), "rule__OperationDeclaration__IsConstructorAssignment_0_0");
					put(grammarAccess.getOperationDeclarationAccess().getIsDestructorAssignment_0_1(), "rule__OperationDeclaration__IsDestructorAssignment_0_1");
					put(grammarAccess.getOperationDeclarationAccess().getVisibilityIndicatorAssignment_1(), "rule__OperationDeclaration__VisibilityIndicatorAssignment_1");
					put(grammarAccess.getOperationDeclarationAccess().getAbstractAssignment_2(), "rule__OperationDeclaration__AbstractAssignment_2");
					put(grammarAccess.getOperationDeclarationAccess().getNameAssignment_3(), "rule__OperationDeclaration__NameAssignment_3");
					put(grammarAccess.getOperationDeclarationAccess().getFormalParametersAssignment_4(), "rule__OperationDeclaration__FormalParametersAssignment_4");
					put(grammarAccess.getOperationDeclarationAccess().getReturnTypeAssignment_5_1(), "rule__OperationDeclaration__ReturnTypeAssignment_5_1");
